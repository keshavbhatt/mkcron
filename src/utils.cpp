...
QString utils::removeNodeColor(QString input)
{
    QStringList colors;
    QString output;
    colors<<"\x1b[0m"<<"\x1b[1m"<<"\x1b[2m"<<"\x1b[4m"
         <<"\x1b[5m"<<"\x1b[7m"<<"\x1b[8m"<<"\x1b[30m"
        <<"\x1b[31m"<<"\x1b[32m"<<"\x1b[33m"<<"\x1b[34m"
       <<"\x1b[35m"<<"\x1b[36m"<<"\x1b[37m"<<"\x1b[40m"
      <<"\x1b[41m"<<"\x1b[42m"<<"\x1b[43m"<<"\x1b[44m"
     <<"\x1b[45m"<<"\x1b[46m"<<"\x1b[47m"<<"\x1b[39m"<<"\x1b[22m ";
...
{
    QStringList video = {".3g2",".3gp",".aaf",".asf",".avchd",".avi",".drc",".flv",
                         ".m2v",".m4p",".m4v",".mkv",".mng",".mov",".mp2",".mp4",
                         ".mpe",".mpeg",".mpg",".mpv",".mxf",".nsv",".ogg",".ogv",
                         ".ogm",".qt",".rm",".rmvb",".roq",".srt",".svi",".vob",
                         ".webm",".wmv",".yuv"};
...
{
    QStringList audio = {".aac",".aiff",".ape",".au",".flac",".gsm",".it",".m3u",
...
{
    QStringList images = {".3dm",".3ds",".max",".bmp",".dds",
                          ".gif",".jpg",".jpeg",".png",".psd",
                          ".xcf",".tga",".thm",".tif",".tiff",
                          ".yuv",".ai",".eps",".ps",".svg",".dwg",
